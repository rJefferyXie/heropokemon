...
const Floors = () => {
  ...
  useEffect(() => {
    ...
    const lastFloorDigit = +(floor.currentFloor.toString().slice(-1));
    if ((lastFloorDigit === 6 || lastFloorDigit === 1) && floor.currentFloor > floor.highestFloor) {
      ...
      dispatch(allActions.alertActions.addAlert(`For beating floor ${floor.currentFloor - 1}, you earned $${goldReward} and ${bpReward}BP!`));
    }
